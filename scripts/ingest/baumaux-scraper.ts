...
const SEED_URLS = [
  `${BASE}/170237-graines-de-tomates`,
  `${BASE}/169585-graines-de-laitues`,
  `${BASE}/170742-graines-de-courges`,
  `${BASE}/170617-graines-de-concombres`,
  `${BASE}/170662-graines-de-courgettes`,
  `${BASE}/168886-graines-de-carottes`,
  `${BASE}/169171-graines-de-choux`,
  `${BASE}/170128-graines-de-radis`,
];
const DELAY_MS = 2500;
